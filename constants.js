...
if (!SHEET_ALIAS_TO_NAME_MAP) {
  SHEET_ALIAS_TO_NAME_MAP = {"EXPENSES": "EXPENSES", "INCOME": "VARIABLE INCOME", "MONTHLY": "MONTHLY EXPENSES", "CATEGORIES": "CATEGORIES", "SPENDING": "SPENDING", "TRACK": "TRACK"};
  SCRIPT_PROPERTIES.setProperty(SPREADHSHEED_MAP_KEY, JSON.stringify(SHEET_ALIAS_TO_NAME_MAP));
}
