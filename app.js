...
function doPost(e) {
  ...
  try {
    ...
    DEBUG_MODE &&
      writeErrorToSheet(["Error parsing Telegram update: " + error.message]);
...
function handleUpdate(update) {
  ...
  if (messageText.startsWith("/")) {
    DEBUG_MODE &&
      writeErrorToSheet(["Successfully handling command: " + messageText]);
    handleCommand(messageText, chatId);
  } else {
    DEBUG_MODE &&
      writeErrorToSheet(["About to handle expenses: " + messageText]);
